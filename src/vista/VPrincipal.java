...
public class VPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMINuevo = new JMenuItem();
        jMIAbrir = new JMenuItem();
        jSeparator1 = new JPopupMenu.Separator();
        jMIGuardar = new JMenuItem();
        jSeparator2 = new JPopupMenu.Separator();
        jMICerrar = new JMenuItem();
        jMenu4 = new javax.swing.JMenu();
        jMIIr = new JMenuItem();
        jMenu3 = new javax.swing.JMenu();
        jMIVerificar = new JMenuItem();
        jMenu5 = new javax.swing.JMenu();
        jMICompile = new JMenuItem();
        jMenu2 = new javax.swing.JMenu();
        JMIInformacion = new JMenuItem();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jTPArchivos.setBackground(new Color(51, 51, 51));
        jTPArchivos.setForeground(new Color(51, 51, 51));
        jTPArchivos.setAutoscrolls(true);
        jTPArchivos.setFont(new Font("Candara", 0, 12)); // NOI18N
        ...
        jMenuBar1.setForeground(new Color(0, 0, 204));
        ...
        jMenu3.setForeground(new Color(0, 153, 0));
    ...
    private void jMINuevoActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jMINuevoActionPerformed
    ...
    private void jTPArchivosMouseClicked(MouseEvent evt) {//GEN-FIRST:event_jTPArchivosMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_jTPArchivosMouseClicked

    private void jTPArchivosMousePressed(MouseEvent evt) {//GEN-FIRST:event_jTPArchivosMousePressed
        //Menú click derecho.
    ...
    private void jMIAbrirActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jMIAbrirActionPerformed
    ...
    private void jMIGuardarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jMIGuardarActionPerformed
        JFileChooser chooser = new JFileChooser();
        FileNameExtensionFilter filter = new FileNameExtensionFilter("AFE", "afe");
        chooser.setFileFilter(filter);
    ...
    private void jMICerrarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jMICerrarActionPerformed
        this.dispose();
    }//GEN-LAST:event_jMICerrarActionPerformed

    private void jMIVerificarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jMIVerificarActionPerformed
    ...
    private void jMIIrActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jMIIrActionPerformed
        JViewport viewport = ((JScrollPane) jTPArchivos.getSelectedComponent()).getViewport();
        JTextPane textPane = (JTextPane) viewport.getView();
    ...
    private void JMIInformacionActionPerformed(ActionEvent evt) {//GEN-FIRST:event_JMIInformacionActionPerformed
        
        new About(this, true).setVisible(true);
        
    }//GEN-LAST:event_JMIInformacionActionPerformed

    private void jMICompileActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jMICompileActionPerformed
    ...
    private JMenuItem JMIInformacion;
    private JMenuItem jMIAbrir;
    private JMenuItem jMICerrar;
    private JMenuItem jMICompile;
    private JMenuItem jMIGuardar;
    private JMenuItem jMIIr;
    private JMenuItem jMINuevo;
    private JMenuItem jMIVerificar;
